        ...
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden animate-slide-up">
                ...
                <div className="bg-red-600 px-6 py-5 text-center">
                    ...
                    <p className="text-red-100 text-[11px] mt-1 font-medium">
                        {restaurantData?.name}
                    </p>
                </div>
                    ...
                    {isClosedToday ? (
                        <>
                            ...
                            {nextOpen && (
                                <div className="mt-3 bg-green-50 border border-green-100 rounded-xl p-3">
                                    ...
                                    <p className="text-green-800 font-black text-base">
                                        {nextOpen.day} at {fmt(nextOpen.time)}
                                    </p>
                                </div>
                            )}
                        </>
                        ...
                        <>
                            <p className="text-gray-600 text-sm font-medium mb-3">
                                We're currently closed. Our doors are open
                                during:
                            </p>
                            ...
                            <p className="text-gray-400 text-[11px] mt-3">
                                Come back during opening hours to place your
                                order.
                            </p>
                        </>
                    ) : (
    ...
    const categoryItems = useMemo(() => {
        if (activeCategory === "all") {
            return menu.flatMap((c) =>
                c.items.filter((i) => i.isAvailable !== false),
            );
        }
                ...
                <div className="border border-border p-6 w-full max-w-sm">
                    ...
                    {tableNumber && (
                        <p className="text-xs text-muted mt-1">
                            Table {tableNumber} • Pay at counter
                        </p>
                    )}
                </div>
                <button
        ...
        <div className="min-h-screen bg-white flex flex-col">
                ...
                <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-3">
                    {restaurantData?.logo && (
                        <LazyImg
                            ...
                            className="w-10 h-10 object-cover border border-white/20 rounded flex-shrink-0"
                        />
                    )}
            ...
            {!isOpen && (
                ...
                >
                    ...
                    <span className="text-[9px] font-bold text-red-500 uppercase tracking-widest underline whitespace-nowrap">
                        See Hours
                    </span>
                </div>
            )}
                                    ...
                                    >
                                        {item.imageUrl && (
                                            <LazyImg
                                                src={item.imageUrl}
                                                alt={item.name}
                                                className="w-14 h-14 object-cover flex-shrink-0 rounded"
                                            />
                                        )}
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-1.5 flex-wrap">
                                                ...
                                                {item.dietType === "veg" && (
                                                    <span
                                                        title="Vegetarian"
                                                        className="inline-flex items-center justify-center w-4 h-4 border border-green-600 flex-shrink-0"
                                                    >
                                                ...
                                                {item.dietType ===
                                                    ...
                                                    <span
                                                        ...
                                                        className="inline-flex items-center justify-center w-4 h-4 border border-red-600 flex-shrink-0"
                                                    >
                                                ...
                                                {item.dietType === "vegan" && (
                                                    <span
                                                        title="Vegan"
                                                        className="inline-flex items-center justify-center w-4 h-4 border border-emerald-600 flex-shrink-0"
                                                    >
                                                        <span className="w-2 h-2 rounded-full bg-emerald-600" />
                                                    </span>
                                                )}
                                                {item.isBestSeller && (
                                                    <span className="text-[8px] bg-amber-100 text-amber-700 px-1.5 py-0.5 font-bold uppercase rounded">
                                                        🔥 Best Seller
                                                    </span>
                                                )}
                                                {item.isChefSpecial && (
                                                    <span className="text-[8px] bg-blue-100 text-blue-700 px-1.5 py-0.5 font-bold uppercase rounded">
                                                        👨‍🍳 Chef Special
                                                    </span>
                                                )}
                                            </div>
                                        ...
                                        {inCart ? (
                                            ...
                                            <button
                                                ...
                                                className="bg-black text-white text-[9px] font-bold tracking-wider uppercase px-3 py-2 flex-shrink-0 active:scale-95 transition-transform"
                                            >
                                                ADD
                                            </button>
                                        )}
                ...
                <div className="fixed inset-0 bg-white z-50 flex flex-col overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto px-4 py-5 space-y-5">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <button
                                    ...
                                    className={`flex items-center justify-center gap-2 py-3 text-xs font-bold tracking-wider uppercase border transition-colors ${orderType === "Dine-In" ? "bg-black text-white border-black" : "bg-white border-border text-muted"}`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex items-center justify-center gap-2 py-3 text-xs font-bold tracking-wider uppercase border transition-colors ${orderType === "Takeaway" ? "bg-black text-white border-black" : "bg-white border-border text-muted"}`}
                                >
                                ...
                                {cart.map((item) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-3 flex-shrink-0">
                                            ...
                                            <span className="font-bold text-xs w-14 text-right">
                                                ₹
                                                {(
                                                    item.price * item.qty
                                                ).toFixed(0)}
                        ...
                        <div className="space-y-4">
                            <label className="block text-[10px] font-bold tracking-widest uppercase text-muted">
                                Your Details
                            </label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="input-premium pl-10 !py-3 !text-sm"
