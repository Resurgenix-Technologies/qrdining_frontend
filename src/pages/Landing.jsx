    ...
    <div className="border border-border p-10 text-left relative overflow-hidden">
      ...
      <section className="bg-black py-24 md:py-32">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-white/40 text-sm md:text-base mb-12 max-w-md mx-auto leading-relaxed">
            Join restaurants already using QR Dining to streamline orders and delight customers.
          </p>
      ...
      <footer className="border-t border-border bg-white py-16 text-sm text-muted">
        <div className="max-w-3xl mx-auto px-6 flex flex-col items-center text-center gap-8">
          <div>
            <span className="font-black tracking-[0.2em] uppercase text-xl text-primary block mb-2">QR Dining</span>
          ...
          <div className="pt-8 border-t border-border/50 w-full">
            <p className="text-[10px] text-muted-light/60 tracking-wider">© 2026 QR Dining. All rights reserved.</p>
